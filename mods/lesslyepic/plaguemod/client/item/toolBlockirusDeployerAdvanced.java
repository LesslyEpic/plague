...
public class toolBlockirusDeployerAdvanced extends Item{
	
public toolBlockirusDeployerAdvanced(int par1) {
	super(par1);
	setUnlocalizedName("toolBlockirusDeployerAdvanced");
	setMaxStackSize(1);
...
public void registerIcons(IconRegister iconRegister) {
	itemIcon = iconRegister.registerIcon("lesslyepic:blockirus_deploy_adv");
	}
}